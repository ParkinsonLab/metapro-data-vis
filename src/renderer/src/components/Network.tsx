...
const get_formatted_network_data = (parsed_data, network_data, pathway, ann_map, height, width) => {
    ...
    } = condense_to_tax_group(data, tax_idx, tax_map)
...
const Pathway = ({ base_width, base_height, pathway, ann_map }): React.JSX.Element => {
        ...
        const node_selection = svg.append("g")
            ...
            .join(enter => {
                ...
                g.each(function(d) {
                    ...
                    const symbolPath = pie_g.insert('path', null)
    ...
    <div id="pathway-container">
        <div id="top-row">
            <span id="pathway-back-button" className="bold" onClick={handle_back_click}>{"< Back"}</span>
        ...
        <div>
            {
                ...
                <Pathway base_width={width} base_height={height} pathway={selected_pathway} ann_map={ann_map} />
                :
